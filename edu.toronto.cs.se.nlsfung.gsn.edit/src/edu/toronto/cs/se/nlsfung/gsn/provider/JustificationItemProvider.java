...
/**
 * This is the item provider adapter for a {@link edu.toronto.cs.se.nlsfung.gsn.Justification} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Justification_state_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Justification_state_feature", "_UI_Justification_type"),
				 GSNPackage.Literals.JUSTIFICATION__STATE,
				 true,
				 false,
				 false,
